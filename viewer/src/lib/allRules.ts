...
export const ALL_RULES: RuleDefinition[] = [
  ...
  { id: "H16", scope: "Step", description: "VEND step requires container or packaging target", appliesTo: "VEND steps" },
  ...
  { id: "C2", scope: "Build", description: "external_build consumes must be declared in requiresBuilds" },
